                ...
                <div class="signup-form" style="width:60%">
                    <form method="POST" class="register-form" id="register-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="uname" id="uname" Placeholder="New Password" minlength="5" required />
                            <!-- <span class="text-warning">Can only Contain @ for Email</span> -->
                        ...
                        <div class="form-submit" style="display: flex; justify-content: center; align-items: center;">
                            ...
                            <button type="login" name="login"  class="submit btn-primary"  style="width:300px;" id="login">Change Password</button>
                        </div>
                    </form>
                </div>
            </div>
