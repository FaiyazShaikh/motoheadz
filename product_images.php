...
<body>
                ...
                <div class="signup-form" style="width:60%">
                    <form method="POST" action="" class="register-form" id="register-form">
                        ...
                        <div class="form-group">
                            <label for="vimg1">Vehicle-Image-1</label>
                            <input type="file" name="vimg1" id="vimg1"/>
                            <!-- <span class="text-warning">Vehicle-Name does not contain Special Characters</span> -->
                        </div>                     
                        <div class="form-group">
                            <label for="vimg2">Vehicle-Image-2</label>
                            <input type="file" name="vimg2" id="vimg2"/>
                            <!-- <span class="text-warning">Vehicle-Name does not contain Special Characters</span> -->
                        </div>                     
                        <div class="form-group">
                            <label for="vimg3">Vehicle-Image-3</label>
                            <input type="file" name="vimg3" id="vimg3"/>
                            <!-- <span class="text-warning">Vehicle-Name does not contain Special Characters</span> -->
                        </div>                     
                        <div class="form-group">
                            <label for="vimg4">Vehicle-Image-4</label>
                            <input type="file" name="vimg4" id="vimg4"/>
                            <!-- <span class="text-warning">Vehicle-Name does not contain Special Characters</span> -->
                        </div>                     
                        <div class="form-group">
                            <label for="vimg5">Vehicle-Image-5</label>
                            <input type="file" name="vimg5" id="vimg5"/>
                            <!-- <span class="text-warning">Vehicle-Name does not contain Special Characters</span> -->
                        </div>                     
                        <div class="form-submit">
                            <input type="reset" value="Reset All" class="submit" name="reset" id="reset" />
                            <button type="submit" name="upload" class="submit" id="submit">Next &gt</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    if(isset($_POST['upload'])){
        ...
        $vimg4=$_POST['vimg4'];
        $vimg5=$_POST['vimg5'];
         header("Location:prdocs.php?pid=$pid");
