...
<body>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Edit Consultancy</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="">Home</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Edit Consultancy</h6>
        </div>
    </div>
    <!-- Page Header End -->
    <div class="main mt-3">
            ...
            <div class="signup-content" style="display: flex; justify-content: center; align-items: center;">
                ...
                <div class="signup-form" style="width:60%">
                    <form method="POST" class="register-form" id="register-form">
                        <h2>Consultancy Updation form</h2>

                        <div class="form-group">
                            <label for="conname">Consultancy-Name :</label>
                            <input type="text" name="conname" id="conname" Value="New Con" minlength="5" required />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="congstin" id="congstin" value="24MCVBE7588KJ45" minlength="15" disabled/>
                            <span class="text-warning">GSTIN Cannot be Changed</span>
                        </div>
                        <div class="form-group">
                            <label for="condesc">Description :</label>
                            <input type="text" name="condesc" minlength="100" id="condesc" value="We New Con Are Trusted Consultancies From Past 15 Years">
                            <!-- <span class="text-warning">Must be 100 Characters</span> -->
                        </div>
                        <div class="form-group">
                            <label for="conaddress">Address :</label>
                            <input type="text" name="conaddress" minlength="50" Value="Shop No 45, Makaraba Road, Sarkhej Highway, Sarkhej" id="conaddress">
                        </div>
