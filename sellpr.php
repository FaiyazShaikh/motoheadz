...
<body>
            ...
            <div class="signup-content" style="display: flex; justify-content: center; align-items: center;">
                ...
                <div class="signup-form" style="width:60%">
                    <form method="POST" class="register-form" id="register-form">
                        ...
                        <div class="form-group">
                            <label for="kmdr">Kms Driven:</label>
                            <input type="number" name="kmdr" id="kmdr" placeholder="Ex - 25000" required />
                        </div>
                        <div class="form-group">
                            <label for="kmdr">Model Year::</label>
                            <input type="number" placeholder="Ex - 2015" required />
                        </div>
                        <div class="form-group">
    ...
    if(isset($_POST['submit'])&&((($_POST['vprice'])&&($_POST['kmdr']))!="")){
        $vprice=$_POST['vprice'];
        $ftype=$_POST['ftype'];
        if($ftype==1){
            $ftype="Petrol";
