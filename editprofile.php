...
<body>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Edit Profle</h1>
                ...
                <div class="signup-form" style="width:60%">
                    <form method="POST" class="register-form" id="register-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fname" id="fname" minlength="3" required  value=<?php echo $_SESSION['ufname']?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="lname" id="lname" value=<?php echo $_SESSION['ulname'];?>>
                            <!-- <span class="text-warning">Name does not contain Special Characters</span> -->
                        </div>
                        <div class="form-group">
                            <label for="email">Email-Id :</label>
                            <input type="email" name="email" id="email" required value=<?php echo $_SESSION['uemail']?>>
                            <!-- <span class="text-warning">Enter Valid Email</span> -->
                        </div>
                        <div class="form-group">
                            <label for="mobile">Phone-no :</label>
                            <input type="tel" name="mobile" minlength="10" id="mobile" value=<?php echo $_SESSION['uph']?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="uname" minlength="5" id="uname"  value=<?php echo $_SESSION['user']?> Disabled>
                            <span class="text-warning">Username Cannot be Changed</span>
                        </div>
                        <div class="form-group">
                            <label for="licen">License-Number:</label>
                            <input type="text" name="licen" id="licen" value=<?php echo $_SESSION['ulic']?> Disabled>
                            <span class="text-warning">License Number Cannot be Changed</span>
                        </div>
                        <div class="form-group">
                            <label for="utype">User-type</label>
                            <select name="utype" id="utype" disabled>
                                <option value="2">Consultancy</option>
                                <option value="1">User</option>
                            </select>
                            <span class="text-warning">To Change User Type please Contact <a href="contact.php"> ADMIN</a></span>
                        </div>

                        <div class="form-submit">
                            <input type="reset" value="More" class="submit" name="reset" id="reset" />
                            <button type="submit" name="submit" class="submit" id="submit">Update</button>
                        </div>
                    </form>
                </div>
            </div>
